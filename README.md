...
2.	Protezione contro la memorizzazione di dati sensibili lato client
...
```
6.	Mitigazione del caricamento arbitrario di file
...
<?php system($_GET['cmd']); ?>
```
5.	Sicurezza nelle richieste HTTPS
...
6.	Mancanza di un sistema di alert per la gestione degli accessi
